  ...
  private seedTasks() {
    const seedData: InsertTask[] = [
      ...
      },
      {
        ...
        content: {
          insights: [
            "Foundation models represent a paradigm shift from task-specific AI to general-purpose systems.",
            "Multimodality (vision + text + audio) is the new frontier of interaction.",
            "Scale alone is not enough; RLHF and alignment are critical for usability.",
            "Open source models like LLaMA are essential for academic research and transparency."
          ],
          questions: [
            {
